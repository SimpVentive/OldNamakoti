...
import com.unitol.namakoti.adapters.PrintTypesAdapter;
...
public class PrintTypeDialogActivity extends Activity {

    protected static final String TAG = "NamasDialogActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainTitle.setText("Select the print type");

        String temples = MyApplication.mPref.getString(getResources().getString(R.string.pref_print_types_pd_key), "");

        PrintTypesAdapter templesAdapter = new PrintTypesAdapter(this, parseUserNamas(temples));
        countryList.setAdapter(templesAdapter);
        ...
        countryList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View viewLV, int arg2, long arg3) {
                ...
                intent.putExtra(ConstantsManager.PRINT_TYPE_JSON, jsonObject.toString());

                setResult(ConstantsManager.PRINT_TYPE_CODE, intent);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(PrintTypeDialogActivity.this);
