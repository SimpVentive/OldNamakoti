...
public class PaymentDialogActivity extends Activity implements OnClickListener{
...
//	private String status_dateDP;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String payments = getIntent().getExtras().getString(ConstantsManager.PAYMENT_JSON);
...
//			Log.i(TAG, "jsonObject: "+jsonObject);
		...
		observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(PaymentDialogActivity.this);
				...
				mainTitle.getLayoutParams().width = LayoutParams.MATCH_PARENT;
				mainTitle.requestLayout();
				
				cancel_btn.getLayoutParams().height = h;
				cancel_btn.getLayoutParams().width = LayoutParams.MATCH_PARENT;
				cancel_btn.requestLayout();
				
				main_layout.getLayoutParams().height = LayoutParams.WRAP_CONTENT;
				main_layout.getLayoutParams().width = (int) ((0.95f)*width);
