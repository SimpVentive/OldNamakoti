...
import com.unitol.namakoti.adapters.CountAdapter;
...
public class CountDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainTitle.setText("Select the count");

        String temples = MyApplication.mPref.getString(getResources().getString(R.string.pref_count_numbers_pd_key), "");

        CountAdapter templesAdapter = new CountAdapter(this, parseUserNamas(temples));
        ...
        countryList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View viewLV, int arg2, long arg3) {
                ...
                intent.putExtra(ConstantsManager.COUNT_JSON, jsonObject.toString());

                setResult(ConstantsManager.COUNTS_CODE, intent);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(CountDialogActivity.this);
