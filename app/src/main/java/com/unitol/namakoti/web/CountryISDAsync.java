...
import com.unitol.namakoti.LanugaugeAdapter;
...
public class CountryISDAsync extends AsyncTask<String, Void, String>{
...
//	private Spinner namam_type_spinner;
	...
	public CountryISDAsync(Activity c, Spinner language_spinner, Spinner namam_type_spinner) {
		ctx = c;
...
//		this.namam_type_spinner = namam_type_spinner;
	...
	public CountryISDAsync(Activity c, EditProfileFragmentUrlConnection editProfileFragment) {
		ctx = c;
	...
	private String useHttpurl(String[] inputs) {
		...
		try {
			URL url = new URL(WebConstants.COUNTRY_ISD_CODE);
			Debug.e(TAG, "url:" + WebConstants.COUNTRY_ISD_CODE);
	...
	private HashMap<String, String> getParamsHashMap(String cc) {
		HashMap<String, String> params = new HashMap<String, String>();
		params.put("country_code", cc);
		return params;
	}
