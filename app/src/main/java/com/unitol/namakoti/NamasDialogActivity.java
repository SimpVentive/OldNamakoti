...
public class NamasDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userNamasAvailable = getIntent().getExtras().getString(ConstantsManager.USERNAMAS_AVAILBLE);

        NamasAdapterNew adapter = new NamasAdapterNew(this, parseUserNamas(userNamasAvailable));
...
//				Log.i(TAG, "jsonObject: "+jsonObject);
                ...
                intent.putExtra(ConstantsManager.NAMAS_JSON, jsonObject.toString());

                setResult(ConstantsManager.NAMAS_CODE, intent);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(NamasDialogActivity.this);
