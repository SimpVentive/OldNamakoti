...
import com.unitol.namakoti.adapters.TemplesAdapter;
...
public class TemplesDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainTitle.setText("Select the temple");

        String temples = MyApplication.mPref.getString(getResources().getString(R.string.pref_temples_pd_key), "");


        TemplesAdapter templesAdapter = new TemplesAdapter(this, parseUserNamas(temples));
        ...
        countryList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View viewLV, int arg2, long arg3) {
                ...
                intent.putExtra(ConstantsManager.TEMPLES_JSON, jsonObject.toString());

                setResult(ConstantsManager.TEMPLES_CODE, intent);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(TemplesDialogActivity.this);
