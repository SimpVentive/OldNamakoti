...
public class TemplesAdapter extends BaseAdapter{
	
	private static final String TAG = "SalutationAdapter";
	private List<JSONObject> languagesWithIDList;
	private Activity mActivity;

	public TemplesAdapter(Activity mActivity, List<JSONObject> languagesWithIDList) {
...
//		Log.i(TAG, "getView: "+arg0);"print_type":
//		[{"printing_id":"1","prinitng_name":"Print on Book"}
		
		JSONObject namaObject = languagesWithIDList.get(arg0);
		
		try {
			language.setText(namaObject.getString("temple_name"));
			v.setTag(namaObject);
