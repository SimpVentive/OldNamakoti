...
public class DateDialogActivity extends Activity {
    ...
    protected static final String TAG = "DateDialogActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainTitle.setText("Select the day");

        // String allSalutes =
        // getIntent().getExtras().getString(ConstantsManager.SALUTION_JSON_4_ADAPTER);
        ...
        try {
             ...
             * for (int i = 0; i < allSalutesArray.length(); i++) { JSONObject
             * saute = (JSONObject) allSalutesArray.get(i);
            ...
            DatesAdapter adapter = new DatesAdapter(DateDialogActivity.this,
                    dates);
        ...
        countryList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View viewLV, int arg2,
                ...
                intent.putExtra(ConstantsManager.DATE_JSON_4_ADAPTER,
                        jsonObject);

                setResult(ConstantsManager.DATE_CODE, intent);
        ...
        observer.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                DisplayMetrics metrics = NamaKotiUtils.getDisplayMetrics(DateDialogActivity.this);
