...
public class KarmicSelfBean extends ErrorBean implements Serializable{

    @SerializedName("selfgkc")
    public ArrayList<SelfGkcDetails> selfgkc;

    @SerializedName("total")
    public String total;

    public class SelfGkcDetails  implements Serializable{
