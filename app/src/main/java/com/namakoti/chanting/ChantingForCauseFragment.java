...
public class ChantingForCauseFragment extends BaseFragment implements RecyclerViewClickListener {
    ...
    @BindView(R.id.recyclerViewCause)
    RecyclerView mRecyclerView;
    private ArrayList<GodNamesBean> mGodList;

    public ChantingForCauseFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chanting_for_cause, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mCursor = DatabaseHelper.getNamasListCursor(mBaseActivity.mDatabase,mBaseActivity.mUserIdLong,DatabaseHelper.CHANT_FOR_CAUSE_NAMAS_TABLE_NAME);
    ...
    private void setBundleForChantDetails(int position) {
        if (mCursor.moveToPosition(position)) {
            Intent intent = Utils.setBundleForChantDetails(mBaseActivity, mCursor, Constants.KEY_CHANT_FOR_CAUSE, true);
